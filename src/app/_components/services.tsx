                ...
                >
                  <article className="bg-[#1e293b] text-white rounded-r-2xl p-6 space-y-4 h-full flex flex-col">
                    ...
                    <div className="border-t border-gray-700 pt-4 flex items-center justify-between">
                      ...
                      <a
                        href={`https://wa.me/5551989134037?text=Olá vim pelo site Lênin Pet DEV ${item.title}`}
                        target="_blank"
                        className="flex items-center justify-center gap-2 hover:bg-gray-500 px-4 py-1 rounded-md duration-300"
                      >
